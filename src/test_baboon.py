...
class BaboonsTest(unittest.TestCase):
    ...
    def test_baboon1_should_be_poly(self):
        ...
        baboon.accumulate_poly(2, 0, 0, 2, self.orDict)
    ...
    def test_baboon2_should_be_poly(self):
        ...
        baboon.accumulate_poly(0, 2, 0, 2, self.orDict)
    ...
    def test_baboon3_should_be_poly(self):
        ...
        baboon.accumulate_poly(0, 0, 2, 2, self.orDict)
    ...
    def test_baboon1And2_should_be_poly(self):
        ...
        baboon.accumulate_poly(2, 2, 0, 2, self.orDict)
    ...
    def test_baboon1And3_should_be_poly(self):
        ...
        baboon.accumulate_poly(2, 0, 2, 2, self.orDict)
    ...
    def test_baboon2And3_should_be_poly(self):
        ...
        baboon.accumulate_poly(0, 2, 2, 2, self.orDict)
    ...
    def test_baboon1_should_be_poly_new_pattern_reencode(self):
        reencodeBaboon = baboon.reencode(2)
        self.assertEqual(self.orDict["nrOfPolyType1"], 0)
        baboon.accumulate_poly(reencodeBaboon, 0, 0, 1, self.orDict)
        self.assertEqual(self.orDict["nrOfPolyType1"], 1)

    def test_baboon2And3_should_be_poly_new_pattern_reencode(self):
        reencodeBaboon1 = baboon.reencode(2)
        reencodeBaboon2 = baboon.reencode(2)
        self.assertEqual(self.orDict["nrOfPolyType2And3"], 0)
        baboon.accumulate_poly(0, reencodeBaboon1, reencodeBaboon2,
                               1, self.orDict)
        self.assertEqual(self.orDict["nrOfPolyType2And3"], 1)
